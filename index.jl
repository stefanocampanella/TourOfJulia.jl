...
Finally, we will see how to [solve a sudoku puzzle or the one-dimensional advection equation]($(root * "06_examples" * extension)) using Julia, and putting together a few thing seen along the way.
