...
Finally, we will see simple examples showing how to compress a message with [Huffman coding]($(root * "06c_huffman" * extension)), how to solve the [two-dimensional Laplace equation]($(root * "06a_jacobi" * extension)), the [one-dimensional advection equation]($(root * "06b_smolarkiewicz" * extension)) or a [sudoku puzzle]($(root * "06c_sudoku" * extension)) using Julia, and putting together a few thing seen along the way.
