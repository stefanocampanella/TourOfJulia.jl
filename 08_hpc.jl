...
Julia supports several types of concurrency. There is native support for asynchronous programming usin symmetric coroutines, as in Go.

### Parallel Programming

#### Shared memory

Support for multi-threading and multiprocessing (_one-sided_ using futures).

#### Distributed memory

Using multi-processing or with [MPI.jl](https://github.com/JuliaParallel/MPI.jl)

### Using accelerators

Most mature project is [CUDA.jl](https://github.com/JuliaGPU/CUDA.jl)
"""
...
# ╔═╡ ac261ce2-bc3c-4613-a79a-d3f2b0b48a79
wait(t)
