...
!!! hint
	...
	function neighbors(m, i, j)
		...
		for k in 1:3
			for l in 1:3
				ip = mod(i - 2 + k, size(m, 1)) + 1
				jp = mod(j - 2 + l, size(m, 2)) + 1
				subm[k, l] = m[ip, jp]
			end
		end
		subm
...
let
	...
	neighbors(m, i, j) = [1 0 0   # implement me
						  0 1 0
	                      0 0 0]
...
manifest_format = "2.0"
project_hash = "33b56c428a79a9c8a240e644d446a10d820b3d59"
